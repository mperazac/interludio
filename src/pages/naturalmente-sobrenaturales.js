  ...
  <Layout>
    ...
    <div id="wrapper">
      <section id="main" className="wrapper">
        <div className="inner">
          <h1 className="major">Somos naturalmente sobrenaturales</h1>
          ...
          <p>
            ...
            veamos como simples seres humanos, pero llenos de vida eterna y del
            poder del Espíritu Santo. Naturalmente fallamos, nos ponemos
            ...
            caritativa intervención de Cristo en todas las esferas de nuestra
            vida. Esto nos protege de convertirnos en seres arrogantes que se
            creen superiores. Si alguno de nosotros falla o entra en una
            depresión, entenderemos que aun sigue siendo un ser humano Natural y
            lo animaremos con la esperanza de lo Sobrenatural que nos ha sido
            dado (Hch. 1:8).
          </p>
